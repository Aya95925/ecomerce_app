...
class NetworkError extends AppError{
  NetworkError({String error='Please check your internet connection'}):super(errorMessage: error);

}
class ServerError extends AppError{
  ServerError({String error='Server is down,please try again later'}):super(errorMessage: error);
