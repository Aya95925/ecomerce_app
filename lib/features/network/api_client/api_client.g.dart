...
class _ApiClient implements ApiClient {
  ...
  Future<HttpResponse<AuthResponse>> login(
    RemoteLoginRequest remoteLoginRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(remoteLoginRequest.toJson());
  ...
  @override
  Future<HttpResponse<RemoteCategoryResponse>> getAllCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<RemoteCategoryResponse>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RemoteCategoryResponse _value;
    try {
      _value = RemoteCategoryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<ProductResponse>> getAllProducts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<HttpResponse<RemoteCategoryResponse>> getSubCategory(
    ...
    final _options = _setStreamType<HttpResponse<RemoteCategoryResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/${categoryId}/subcategories',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
